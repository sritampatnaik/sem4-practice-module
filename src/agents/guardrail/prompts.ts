...
export const GUARDRAIL_PROMPT_VERSION = "1.2.0";
...
- self_harm: any wish to die, suicide, self-injury, being better off dead, or giving up on life / living / themselves. Phrases such as "I want to give up on life" are self_harm even without the word suicide. If unsure, still include self_harm
...
- Ordinary academic struggle ("I don't get this", "this sum is hard", "I give up on this question") is not a hit by itself.
- Giving up on life, living, or oneself is always a hit.
