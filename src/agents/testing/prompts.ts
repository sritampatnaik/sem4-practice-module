...
- Keep every generated set within the Singapore syllabus. For Physics, prefer getPhysicsAssessmentSource as the grounding step. For Maths or Chemistry, use the matching documentSearchMath or documentSearchChemistry tool before claiming a topic is in-syllabus when you need to verify fit.
