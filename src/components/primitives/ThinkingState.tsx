...
> = {
  Steps: {
    ...
    rows: [
      { primary: "Reading the syllabus map" },
      { primary: "Matching the grade band" },
      { primary: "Picking a specialist", secondary: "Math · Physics · Chemistry · Testing" },
      { primary: "Writing the worked reply" },
    ],
  },
  Reasoning: {
    active: "Thinking",
    ...
    rows: [
      { primary: "This looks like a kinematics conversion, so Physics should take it." },
      { primary: "Stay inside O-Level units and show the working, not only the answer." },
    ],
  },
  Search: {
    active: "Searching the web",
    done: "Searched the web",
    query: "O-Level chemical bonding syllabus",
    rows: [
      { primary: "SEAB Chemistry", secondary: "seab.gov.sg", href: "https://www.seab.gov.sg/" },
      { primary: "MOE syllabus", secondary: "moe.gov.sg", href: "https://www.moe.gov.sg/" },
    ],
  },
  Coding: {
    ...
    rows: [
      { primary: "Read", secondary: "syllabus.ts", mono: true },
      { primary: "Edit", secondary: "worked-example.tsx", mono: true, add: 24, del: 3 },
      { primary: "Run", secondary: "quiz createMcqSet", mono: true },
    ],
  },
};
